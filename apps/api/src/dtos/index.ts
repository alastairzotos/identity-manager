...
import { identitySchema, loginResponseDto, loginWithEmailAndPasswordDto, loginWithOAuthDto, propertySchema, registerWithEmailAndPasswordDto, verifyPasswordDto } from "@bitmetro/identity";
...
export class LoginWithOAuthDto extends createZodDto(loginWithOAuthDto) {}
